...
try:
    ...
    print("loading Dotenv causes error : ",err)
...
try:
    ...
    print('Error while loading pickle files : ',err)
...
async def login_for_access_token(form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    if userExistCheck:
        ...
        if verifyPwd:
            ...
            userExistCheck['created_at'] = str(userExistCheck['created_at'].isoformat())
...
async def signup_user(user: User):
    ...
    userobj['created_at'] = str(userobj['created_at'].isoformat())
